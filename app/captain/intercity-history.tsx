...
const styles = StyleSheet.create({
  ...
  statsScroll: { maxHeight: 80, paddingVertical: 10 },
  statCard: {
    backgroundColor: "#1E0A3C", borderRadius: 12, paddingHorizontal: 16, paddingVertical: 10,
    alignItems: "center", borderWidth: 1, borderColor: "#9B8EC4", minWidth: 80,
  },
  statValue: { color: "#9B8EC4", fontSize: 18, fontWeight: "800" },
  statLabel: { color: "#6B5A8E", fontSize: 10, marginTop: 2 },
  searchContainer: {
