...
const styles = StyleSheet.create({
  ...
  statusTitle: { fontSize: 22, fontWeight: "800", color: "#2ECC71", marginBottom: 12 },
  statusDesc: { fontSize: 15, color: "#A8D8C0", textAlign: "center", lineHeight: 24 },
  balanceCard: {
    backgroundColor: "#1A3A2A",
    borderRadius: 20,
    padding: 24,
  ...
  transactionsBtnText: { fontSize: 16, fontWeight: "600", color: "#2ECC71" },
  reportCard: {
